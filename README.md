<h1 align="center"> 🚀 PERL Básico </h1>

## ✍️ Descrição
Exemplificação da sintaxe geral e básica da Linguagem PERL
...
1. Clone:
    ...
    ```bash
    git clone git@github.com:cleibp/basic-perl.git
    ```
1. Download:
    ### Download Manual
...
## 👋🏽 DEMO
[REPLIT](https://replit.com/@cleibp/Basic-Perl) 
